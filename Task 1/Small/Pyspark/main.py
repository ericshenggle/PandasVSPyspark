...
input_file_path = '../Datasets/Musical_Instruments.json'          # Patio_Lawn_and_Garden.json
metadata_file_path = '../Datasets/meta_Musical_Instruments.json'       # meta_Patio_Lawn_and_Garden.json
